...
namespace NClass.DiagramEditor.ClassDiagram.ContextMenus
{
  ...
  {
    private readonly ToolStripMenuItem mnuAlign;
    private readonly ToolStripMenuItem mnuAlignTop;
    private readonly ToolStripMenuItem mnuAlignLeft;
    private readonly ToolStripMenuItem mnuAlignBottom;
    private readonly ToolStripMenuItem mnuAlignRight;
    private readonly ToolStripMenuItem mnuAlignHorizontal;
    private readonly ToolStripMenuItem mnuAlignVertical;
    private readonly ToolStripMenuItem mnuMakeSameSize;
    private readonly ToolStripMenuItem mnuSameWidth;
    private readonly ToolStripMenuItem mnuSameHeight;
    private readonly ToolStripMenuItem mnuSameSize;
