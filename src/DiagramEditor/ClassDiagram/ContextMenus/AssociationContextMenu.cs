...
namespace NClass.DiagramEditor.ClassDiagram.ContextMenus
{
  ...
  {
    private readonly ToolStripMenuItem mnuDirection;
    private readonly ToolStripMenuItem mnuUnidirectional;
    private readonly ToolStripMenuItem mnuBidirectional;
